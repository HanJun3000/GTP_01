...
def random_history(N, branching_prob=0.0, circular=False, clocklike=False, generator=None):
...
def simulate(N, branching_prob=0.0, circular=False, clocklike=False, generator=None):
