                    ...
                    for c2 in candidates:
                        ...
                        if c1 == c2:
                            ...
                            if x1 == x2:
                                ...
                                if delta_x1 < delta_y2:
                                    edges.append((c1, c2))
                                    delta.append((delta_x1,delta_y2))
                                else:
                                    edges.append((c2, c1))
                                    delta.append((delta_y2,delta_x1))

                            elif x2 == y1:
                                
                                if delta_x2 < delta_y1:
                                    edges.append((c1, c2))
                                    delta.append((delta_x2,delta_y1))
                                else:
                                    edges.append((c2, c1))
                                    delta.append((delta_y1,delta_x2))
                            
                            elif y1 == y2:

                                if delta_y1 < delta_y2:
                                    edges.append((c1, c2))
                                    delta.append((delta_y1, delta_y2))
                                else:
                                    edges.append((c2, c1))
                                    delta.append((delta_y2,delta_y1))
